...
function autocomplete(input, latInput, lngInput) {
	if (!input) return; //skip running from if there's not input on the page
...
function makeMap(mapDiv) {
	...
	var autocomple = new google.maps.places.Autocomplete(input);
	autocomple.addListener('place_changed', function () {
		var place = autocomple.getPlace();
